 ...
 */
public class WheelVerticalViewForYear extends AbstractWheelView {

    private static int itemID = -1;

    @SuppressWarnings("unused")
    private final String LOG_TAG = WheelVerticalViewForYear.class.getName() + " #" + (++itemID);
     ...
     */
    public WheelVerticalViewForYear(Context context) {
        this(context, null);
    }
     ...
     */
    public WheelVerticalViewForYear(Context context, AttributeSet attrs) {
     ...
     */
    public WheelVerticalViewForYear(Context context, AttributeSet attrs, int defStyle) {
